...
BR = "main"
ANIO_INI, ANIO_FIN = 2000, 2024  # base histórica con stats (circuito principal)
# De 2025 en adelante NO usamos mirror (los disponibles tienen huecos y mezclan Challengers/qualy):
# esa parte la cubre ESPN en recolectar_espn.py, fuente única y sin agujeros.
